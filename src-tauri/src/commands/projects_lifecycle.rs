...
use crate::projects::{IterationStory, NotificationPrefs, Project, ProjectConfig, ProjectDetail, ProjectError, ProjectsByStatus};
...
pub async fn create_project(
    ...
    let normalized_description = required_trimmed(description, "description").map_err(ProjectError::Path)?;
...
pub async fn list_projects(
    db: State<'_, DbState>,
) -> Result<ProjectsByStatus, ProjectError> {
