  ...
  return (
    <Card className="h-fit">
      <CardContent className="space-y-2 p-3">
        <SectionHeader title={<span className="ui-type-label">SYSTEM STATUS</span>} compact className="space-y-1" />
        <div className="space-y-1.5">
          <div className="flex items-center justify-between rounded-md border border-border/60 bg-elevated px-2 py-1.5">
            <span className="ui-type-label font-sans uppercase tracking-[0.14em] text-text-muted">
              Compute Load
            </span>
